...
export default function RegisterPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        // const phone = formData.get("phone") as string // Will save in profile later

        // Simulating API call for now (waiting for keys)
        ...
        <div className="min-h-screen flex items-center justify-center bg-black text-white px-4 relative overflow-hidden">
            ...
            <Card className="w-full max-w-md border-white/10 bg-zinc-900/50 backdrop-blur-xl">
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl font-bold bg-gradient-to-br from-white to-zinc-400 bg-clip-text text-transparent">Crie sua conta</CardTitle>
                    <CardDescription>Comece a automatizar seu atendimento hoje</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-sm font-medium text-zinc-300">Nome Completo</label>
                            <Input name="name" placeholder="João Silva" required className="bg-zinc-800/50 border-white/5 focus-visible:ring-indigo-500" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input name="phone" placeholder="(11) 99999-9999" required className="bg-zinc-800/50 border-white/5 focus-visible:ring-indigo-500" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="text-center text-sm text-zinc-500">
                            Já tem uma conta? <Link href="/login" className="text-white hover:underline">Entrar</Link>
                        </div>
                    </form>
                </CardContent>
            </Card>
